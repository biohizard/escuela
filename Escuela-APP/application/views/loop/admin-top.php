        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav nav-pills col-12 col-lg-auto me-lg-auto mb-2 justify-content-center text-capitalize mb-md-0">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">cobros</a>
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="<?php echo INDEX_PAGE; ?>cobros/servicios/?since=origin#top"   >servicios    </a></li>  
            ...
            <li class="nav-item"><a data-bs-toggle="modal" href="#exampleModalToggle" class="nav-link active" aria-current="page">inscripción</a></li>
          </ul>
          ...
          <div class="dropdown text-end">
            ...
            <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
              ...
              <li><a class="dropdown-item text-capitalize" href="<?php echo INDEX_PAGE; ?>config/?since=origin#top">configuación</a></li>
              <li>
                <hr class="dropdown-divider">
              </li>
  ...
  <svg xmls="http://www.w3.org/2000/svg" style="display: none;">
