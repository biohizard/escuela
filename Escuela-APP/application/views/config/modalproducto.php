...
<div class="modal" id="ModalFechasActualizar" aria-hidden="true" aria-labelledby="ModalFechasActualizar" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <!--Begin: Header -->
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalToggleLabel">Fecha Efectivo Actualizar</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <!--End: Header -->
...
<!--Begin: Modal -->
<div class="modal" id="ModalFechas2Actualizar" aria-hidden="true" aria-labelledby="ModalFechasActualizar2" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">

            <!--Begin: Header -->
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalToggleLabel">Fecha Deposito Actualizar</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <!--End: Header -->
            ...
            <div class="modal-body">
                <div class="col-12 p-3 bg-light">             
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <label for="firstName" class="form-label text-uppercase">Fecha</label>
                                    <input type="date" class="form-control" id="fecha_fecha2" placeholder="" value="" required="">
                                    <div class="invalid-feedback">Fecha.</div>
                                </div>
                            </div>
            ...
            <!--Begin: Footer -->
            <div class="modal-footer"><button class="btn btn-primary" id="btnFecha2Actualizar">actualizar fecha</button></div>
            <!--End: Footer -->
