<div class="container-fluid">
    <div class="row">
        <div class="col-8 offset-2">
            <h1 class="display-4 fw-normal">Configuración</h1>
            <p class="fs-5 text-muted d-none">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec accumsan pulvinar nulla, eu tincidunt lectus rhoncus vel. Etiam quis dictum sapien. Donec eget neque ex..</p>
            <nav>
                    ...
                    <ul class="list-group mb-3">
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            <div class="col-6">
                                ...
                                <small class="text-muted">Colegiatura con descuento </small>
                            </div>
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            <div class="col-6">
                                ...
                                <small class="text-muted">1ra Colegiatura de Agosto </small>
                            </div>
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            <div class="col-6">
                                ...
                                <small class="text-muted">2ra Colegiatura de Agosto </small>
                            </div>
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            <div class="col-6">
                                ...
                                <small class="text-muted">Colegiatura especial </small>
                            </div>
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            <div class="col-6">
                                ...
                                <small class="text-muted">Inscripcion </small>
                            </div>
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-sm">
                            <div class="col-6">
                                ...
                                <small class="text-muted">Descuento Pago Anticipado </small>
                            </div>
