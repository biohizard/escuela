...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="modal" id="modalUpdate" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">

                    <!--Begin: Header -->
                    <div class="modal-header">
                    <h5 class="modal-title text-capitalize" id="exampleModalToggleLabel">modificar informacion del alumno</h5>
                    ...
                    <div class="modal-footer">
                            <button class="btn btn-primary" id="generaractualizacion">generar actualizacion</button>
                    </div>
                    <!--End: Footer -->
